...
function AtualizarPerfil() {
    ...
    async function buscarUsuarioPorId() {
        try {
            ...
            // Para não carregar a senha criptografada no formulário
            setUser((user) => ({ ...user, senha: "" })) //Mantém os dados do usuário e zera a senha "senha: ''"
            setConfirmarSenha("")
    ...
    // Toda vez que carregar o formulário, resetar tudo para fazer a busca e zerar a senha
    useEffect(() => {
        setUser({} as Usuario)
        setConfirmarSenha("")
        setIsLoading(false)
